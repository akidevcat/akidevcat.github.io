        ...
        <section id="contact">
            <div className="container">
                <div className="row mb-4">
                    <h1 className="title md-5"><span className="title-counter">04. </span>Контакты
                        ...
                        <a href="mailto:akidevcat@gmail.com" className="fg-accent m-2">
                ...
                <div className="row d-flex justify-content-center align-items-center">
                    <p className="fg-primary"><span className="fg-accent">akidevcat@gmail.com<br/>@aki_work</span><br/><br/>Буду рада пообщаться.<br/>До встречи!</p>
                </div>
            </div>
        </section>
    )
